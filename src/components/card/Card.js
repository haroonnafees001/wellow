  ...
  return (
    <>
      <div className="border border-2 border-color-purple rounded-[30px] w-1/3 px-8 py-14 mx-6 text-center Mobile:w-full Mobile:m-0 Mobile:mb-10">
        <div className="w-[114px] h-[114px] bg-white  flex justify-center items-center rounded-full m-auto shadow-gray-50 shadow-md">
          <Image src={web_assets + "icons/1.svg"} width={58} height={58} alt="icons"/>
        </div>
