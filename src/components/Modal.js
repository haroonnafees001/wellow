  ...
  return (
    <div>
      ...
      <button
        onClick={openModal}
        className="
         text-sm flex items-center justify-center font-ProximaNova-Bold bg-color-purple text-white hover:opacity-85 hover:text-white rounded-[50px]  w-[185px] h-[51px] 
