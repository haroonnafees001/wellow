    ...
    <>
      <div className="w-full h-[70vh]">
        <div className="flex items-center justify-center h-full flex-col text-center ">
          <h1 className="text-[70px] text-center font-ProximaNova-Bold leading-[75px]">
